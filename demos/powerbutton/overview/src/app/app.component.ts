...
export class AppComponent implements AfterViewInit, OnInit {	
	...
	init(): void {
        ...
        document.getElementById('powerButtonAnimation').addEventListener('change', function (event: any) {
            (document.getElementById('progressBarAnimated') as ProgressBar).indeterminate = event.detail.value ? false : true;
        });
