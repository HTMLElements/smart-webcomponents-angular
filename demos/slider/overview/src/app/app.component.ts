...
import { Slider, SliderComponent } from '@smart-webcomponents-angular/slider';
...
export class AppComponent implements AfterViewInit, OnInit {	
	...
	init(): void {
        ...
        function setIcon(event: Event) {
            ...
            else if (slider.value < (slider.max as any) / 2) {
        ...
        function setBatteryLevel(event: Event) {
            ...
            else if(document.getElementById('powerSaver')){
