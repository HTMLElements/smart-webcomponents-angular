...
import { SchedulerComponent, SchedulerDataSource, SchedulerResource, SchedulerViews, SchedulerViewType, SchedulerGroupOrientation } from '@smart-webcomponents-angular/scheduler';
