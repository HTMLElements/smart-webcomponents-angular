...
BaseElement.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: BaseElement, inputs: { locale: "locale", localizeFormatFunction: "localizeFormatFunction", messages: "messages", rightToLeft: "rightToLeft", theme: "theme" }, outputs: { onCreate: "onCreate", onReady: "onReady", onAttach: "onAttach", onDetach: "onDetach" } });
...
BreadcrumbComponent.propDecorators = {
    ...
    closeButtons: [{ type: Input }],
    dataSource: [{ type: Input }],
    disabled: [{ type: Input }],
    itemTemplate: [{ type: Input }],
    locale: [{ type: Input }],
    messages: [{ type: Input }],
    minimizeWidth: [{ type: Input }],
    unfocusable: [{ type: Input }],
    onClose: [{ type: Output }],
    onClosing: [{ type: Output }],
    onDragEnd: [{ type: Output }],
    onDragging: [{ type: Output }],
    onAddNewItem: [{ type: Output }]
};
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(BreadcrumbComponent, [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }]; }, { onClose: [{
            type: Output
        }], onClosing: [{
            type: Output
        }], onDragEnd: [{
...
BreadcrumbModule.ɵinj = ɵngcc0.ɵɵdefineInjector({});
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(BreadcrumbModule, { declarations: [BreadcrumbComponent], exports: [BreadcrumbComponent] }); })();
