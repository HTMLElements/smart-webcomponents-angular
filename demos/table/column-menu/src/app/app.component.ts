...
import {
  TableComponent,
  TableColumn,
} from '@smart-webcomponents-angular/table';
...
export class AppComponent implements AfterViewInit, OnInit {
  ...
  getOrderData() {
    const orderData = [],
      ...
      countries = ['de', 'it', 'gb', 'us', 'il', 'in', 'cn'];
    for (let i = 0; i < 100; i++) {
  ...
  columns: TableColumn[] = [
    ...
    { label: 'Date', dataField: 'date', dataType: 'date' },
    {
      ...
      formatFunction(settings) {
        settings.template =
          '<img class="flag" style="width: 40px; height: 27px;" src="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.4.6/flags/1x1/' +
          settings.value +
          '.svg" />';
      },
    },
