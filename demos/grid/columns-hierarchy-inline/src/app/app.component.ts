...
export class AppComponent implements AfterViewInit {
  ...
  columns = [
    ...
    },
    {
      ...
      collapsed: true,
      detailColumns: ['Air Quality Metrics.PM2.5', 'Air Quality Metrics.PM10', 'Air Quality Metrics.NO2', 'Air Quality Metrics.O3'],
      cellsRenderer: (row: number, column: any, value: string) => {
        let color = '#2ECC40';
  ...
  ngAfterViewInit(): void {
    // No additional initialization needed as all config is bound via template
  }
}
