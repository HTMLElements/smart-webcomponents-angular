...
export class AppComponent implements AfterViewInit, OnInit {
	...
	onCellEditRequest = (id: string, dataField: string, value: any, oldValue: any, rowData: any) => {
   ...
   editing: GridEditing = {
	...
	columns: any =[
		...
		{
			label: 'Status', align: 'left', width: 90, dataField: 'expired', showIcon: true, icon: 'expired', formatFunction: function (settings: any) {
