...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [  CheckBoxModule, RadioButtonModule, ColorPickerModule ],
...
export class AppComponent implements AfterViewInit, OnInit {	
	...
	init(): void {
        ...
        that.options.nativeElement.addEventListener(
          'change',
          function (event: CustomEvent): void {
            ...
            if (
              (radioButton.nodeName == 'SMART-RADIO-BUTTON' &&
